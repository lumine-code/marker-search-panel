...
- **[marker.layer](https://lumine-code.github.io/docs.html#services/marker.layer)** (`1.0.0`): provided to render search result markers as a layer on the editor's overview maps.
